...
{
    public class CharacteristicUpdateRequestModelValidator : AbstractValidator<CharacteristicUpdateRequestModel>
    {
        public CharacteristicUpdateRequestModelValidator()
        {
            RuleFor(x => x.Title)
