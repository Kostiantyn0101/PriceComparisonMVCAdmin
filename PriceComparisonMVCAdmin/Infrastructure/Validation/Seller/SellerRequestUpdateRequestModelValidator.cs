...
{
    public class SellerRequestUpdateRequestModelValidator : AbstractValidator<SellerRequestUpdateRequestModel>
    {
        public SellerRequestUpdateRequestModelValidator()
        {
            RuleFor(x => x.Id)
